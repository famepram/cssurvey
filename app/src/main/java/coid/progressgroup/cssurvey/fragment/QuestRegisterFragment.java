 ...
 */
public class QuestRegisterFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        mView   =  (LinearLayout)inflater.inflate(R.layout.fragment_quest_register, container, false);
        mAct    = (SurveyActivity) getActivity();
        BtnSaveNext = (Button) mView.findViewById(R.id.ButtonQuestRegisterSave);
